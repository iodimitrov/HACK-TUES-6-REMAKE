  ...
  return (
    <Container maxWidth={false}>
      ...
      <Container maxWidth='lg'>
                ...
                <Card className={styles.card} key={i}>
                  ...
                  <CardContent className={styles['card-content']}>
                    ...
                    <Typography component='p'>
                      <strong>Участници:</strong> {winner.participants}
                    </Typography>
                    <br />
                    <Typography component='p'>
                      <strong>Проект:</strong> {winner.project}
                    </Typography>
                  </CardContent>
                </Card>
              ))}
        ...
        <Grow in timeout={400}>
          <Container disableGutters className={styles['description-container']}>
            <Card className={styles.card}>
              <Box className={styles['card-uppersection']}>
                <CardHeader
                  ...
                  title='За събитието'
                />
                <CardActions className={styles['card-actions']} disableSpacing>
                  <Button
                    ...
                    variant='contained'
                  >
                    {expanded ? 'Прочети по-малко' : 'Прочети повече'}
                  </Button>
                </CardActions>
              </Box>
              <Collapse in={expanded} timeout='auto' collapsedHeight={200}>
                <CardContent className={styles['card-content']}>
                  <Typography
